---
"@ezihegodswill/abi-to-hooks": minor
---

- **Simulate Hooks Generation**: Added synthesis for `useSimulateContract` custom hooks for all `nonpayable` and `payable` write methods alongside `useWriteContract`.
